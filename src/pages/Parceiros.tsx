  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-background">
      ...
      <main className="flex-grow">
        ...
        {/* Seção "Automatize sua comunicação e impulsione suas vendas" */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Respostas automáticas para perguntas frequentes, confirmações de pedidos e muito mais, disponíveis 24/7.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Envie campanhas segmentadas para seus clientes, aumentando o engajamento e as vendas recorrentes.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Relatórios detalhados para acompanhar o desempenho de suas automações e otimizar seus resultados.
                </p>
              </div>
            </div>
          </div>
